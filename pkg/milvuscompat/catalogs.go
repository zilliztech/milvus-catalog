...
type rootCoordCatalog struct{ c catalog.Catalog }
type dataCoordCatalog struct{ c catalog.Catalog }
type queryCoordCatalog struct{ c catalog.Catalog }
type streamingCoordCatalog struct{ c catalog.Catalog }
type streamingNodeCatalog struct{ c catalog.Catalog }
...
func (r rootCoordCatalog) AlterPartition(ctx context.Context, dbID int64, oldPart *model.Partition, newPart *model.Partition, alterType metastore.AlterType, ts typeutil.Timestamp) error {
	return r.c.Metadata().Partitions().Alter(ctx, catalog.AlterPartitionRequest{DatabaseID: dbID, Old: oldPart, New: newPart, AlterType: alterType}, wo(ts))
}
...
func (r rootCoordCatalog) SaveFileResource(ctx context.Context, resource *internalpb.FileResourceInfo, version uint64) error {
	return r.c.Metadata().Files().Save(ctx, resource, version, catalog.WriteOptions{})
}

func (r rootCoordCatalog) RemoveFileResource(ctx context.Context, resourceID int64, version uint64) error {
	return r.c.Metadata().Files().Remove(ctx, resourceID, version, catalog.WriteOptions{})
}

func (r rootCoordCatalog) ListFileResource(ctx context.Context) ([]*internalpb.FileResourceInfo, uint64, error) {
	return r.c.Metadata().Files().List(ctx, catalog.ReadOptions{})
}
...
func (d dataCoordCatalog) ListSegments(ctx context.Context, collectionID int64) ([]*datapb.SegmentInfo, error) {
	return d.c.Metadata().Segments().List(ctx, catalog.ListSegmentsRequest{CollectionID: collectionID}, catalog.ReadOptions{})
}

func (d dataCoordCatalog) AddSegment(ctx context.Context, segment *datapb.SegmentInfo) error {
	return d.c.Metadata().Segments().Save(ctx, segment, catalog.WriteOptions{})
}
...
func (d dataCoordCatalog) AlterSegments(ctx context.Context, segments []*datapb.SegmentInfo, binlogs ...metastore.BinlogsIncrement) error {
	return d.c.Metadata().Segments().UpdateBatch(ctx, catalog.UpdateSegmentsRequest{Segments: segments, Binlogs: binlogs}, catalog.WriteOptions{})
}

func (d dataCoordCatalog) SaveDroppedSegmentsInBatch(ctx context.Context, segments []*datapb.SegmentInfo) error {
	return d.c.Metadata().Segments().MarkDropped(ctx, segments, catalog.WriteOptions{})
}

func (d dataCoordCatalog) DropSegment(ctx context.Context, segment *datapb.SegmentInfo) error {
	return d.c.Metadata().Segments().Drop(ctx, segment, catalog.WriteOptions{})
}
