...
var _ catalog.Catalog = wrappedCatalog{}

func (w wrappedCatalog) Metadata() catalog.MetadataCatalog {
	return wrappedMetadata{catalogs: w.catalogs}
}
...
func (w wrappedCatalog) InternalState() catalog.MilvusStateCatalog {
	return wrappedState{catalogs: w.catalogs}
}
...
func (w wrappedMetadata) Segments() catalog.SegmentCatalog {
...
func (w wrappedMetadata) Files() catalog.FileResourceCatalog {
	return wrappedFiles{root: w.catalogs.RootCoord, data: w.catalogs.DataCoord}
}

func (w wrappedMetadata) Snapshots() catalog.SnapshotCatalog {
...
func (w wrappedPartitions) Alter(ctx context.Context, req catalog.AlterPartitionRequest, opts catalog.WriteOptions) error {
	...
	return w.root.AlterPartition(ctx, req.DatabaseID, req.Old, req.New, req.AlterType, writeTS(opts))
}
...
func (w wrappedSegments) Get(ctx context.Context, ref catalog.SegmentRef, opts catalog.ReadOptions) (*datapb.SegmentInfo, error) {
	segments, err := w.List(ctx, catalog.ListSegmentsRequest{CollectionID: ref.CollectionID, SegmentIDs: []int64{ref.SegmentID}}, opts)
	if err != nil {
		return nil, err
	}
	if len(segments) == 0 {
...
func (w wrappedSegments) List(ctx context.Context, req catalog.ListSegmentsRequest, opts catalog.ReadOptions) ([]*datapb.SegmentInfo, error) {
	if w.data == nil {
...
func (w wrappedSegments) UpdateBatch(ctx context.Context, req catalog.UpdateSegmentsRequest, opts catalog.WriteOptions) error {
	if w.data == nil {
		return missing("datacoord")
	}
...
func (w wrappedSnapshots) Get(ctx context.Context, req catalog.GetSnapshotRequest, opts catalog.ReadOptions) (*catalog.Snapshot, error) {
	return nil, unsupported("snapshot get")
}

func (w wrappedSnapshots) ListManifests(ctx context.Context, req catalog.ListManifestsRequest, opts catalog.ReadOptions) ([]*catalog.Manifest, error) {
...
func (w wrappedState) DataCoord() catalog.DataCoordStateCatalog {
	return wrappedDataState{data: w.catalogs.DataCoord}
}

func (w wrappedState) QueryCoord() catalog.QueryCoordStateCatalog {
	return wrappedQueryState{query: w.catalogs.QueryCoord}
}

func (w wrappedState) Streaming() catalog.StreamingStateCatalog {
