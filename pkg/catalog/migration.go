...
const (
	...
	MigrationDualWriteEtcdPrimary MigrationPhase = "dual-write-etcd-primary"
	MigrationDualWriteNewPrimary  MigrationPhase = "dual-write-new-primary"
	MigrationNewOnly              MigrationPhase = "new-only"
